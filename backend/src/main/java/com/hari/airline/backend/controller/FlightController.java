...
public class FlightController {
	...
	// Admin Endpoint: Get all flights including past ones
	@GetMapping("/admin/all")
	public ResponseEntity<List<Flight>> getAllFlightsAdmin() {
		return ResponseEntity.ok(flightService.getAllFlightsAdmin());
	}
